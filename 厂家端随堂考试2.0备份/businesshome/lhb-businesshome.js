...
/***/ function(module, exports, __webpack_require__) {
	...
	var pictureurl = "http://oss.aliyuncs.com/testossimg/";
	...
	module.exports = {
	  ...
	  ready: function ready() {
	    ...
	    eventModule.getHomeDatas(function (ret) {
	      ...
	      var GET_URL_MobileBanner = 'http://1525sg4410.51mypc.cn/mingop.php?m=getMobileBanner';

	      var BODY_URL = 'uid=' + ret.uid + '&' + 'sid=' + ret.sid + '&' + '_t=' + ret._t + '&platform=2&version=' + ret.version + '&position=' + positionStr;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    buttons: [{ iconurl: 'http://mingstatic.oss-cn-hangzhou.aliyuncs.com/weex/ios/Image/buiness_suitangexam.png', icontitle: '随堂考试', number: 3, width: 80 }, { iconurl: 'http://mingstatic.oss-cn-hangzhou.aliyuncs.com/weex/ios/Image/buiness_lihuo_log@2x.png', icontitle: '拍一拍', number: 0, width: 80 }, { iconurl: 'http://mingstatic.oss-cn-hangzhou.aliyuncs.com/weex/ios/Image/buiness_sharpiao_log@2x.png', icontitle: '做调研', number: 1, width: 100 }, { iconurl: 'http://mingstatic.oss-cn-hangzhou.aliyuncs.com/weex/ios/Image/buiness_popbtn.png', icontitle: 'POP比赛', number: 2, width: 80 }]
	  }}
	      ...
	      "children": [
	        {
	          "type": "image",
	          "attr": {
	            "src": function () {return this.getimage(this.row.tid)}
	          },
	          "style": {
	            "width": 120,
	            "height": 120,
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.getrewardtitle(this.row.kind)}
	                      }
	                    },
	                    {
	                      "type": "text",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.gettasknumbertitle(this.row.kind)}
	                      }
	                    },
	                    {
	                      "type": "text",
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.getdonenumbertitle(this.row.kind)}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.getdonenumber(this.row.kind,this.row.pass,this.row.quantity_clerk)}
	                      }
	                    }
	                  ]
	                },
	              ...
	              "children": [
	                {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.isselected(this.row.tid,$event)}
	                  },
	                  "children": [
	                    {
	                      "type": "image",
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": function () {return this.getimageshenhestatus(this.row.status)}
	                  },
	                  "style": {
	                    "width": 30,
	                    "height": 30
	                ...
	                },
	                {
	                  ...
	                  "style": {
	                    "color": function () {return this.gettextshenhecolor(this.row.status)}
	                  },
	                  "attr": {
	                    "value": "审核"
	                  }
	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "style": {
	                    "color": function () {return this.gettextcolor(this.row.append)}
	                  },
	                  "attr": {
	                    "value": "追加"
	                  }
...
/***/ function(module, exports) {
	...
	var kquestionimage_url = 'http://oss.aliyuncs.com/testossimg/image/task_list_thumb/';
	...
	module.exports = {
	  ...
	  methods: {
	    ...
	    isselected: function isselected(tid) {
	      ...
	      eventModule.getHomeDatas(function (ret) {
	        ...
	        var GET_URL_setLook = 'http://1525sg4410.51mypc.cn/mingadminmobile.php?m=setLook';
	    ...
	    methods: {
	        requestHomeDatas: function requestHomeDatas() {
	            ...
	            eventModule.getHomeDatas(function (ret) {
	                ...
	                var GET_URL_homeTaskList = 'http://1525sg4410.51mypc.cn/mingadminmobile.php?m=homeTaskList';
	...
	module.exports = {
	  ...
	  ready: function ready() {
	    ...
	    eventModule.getHomeDatas(function (ret) {
	      ...
	      var GET_URL_homeSummary = 'http://1525sg4410.51mypc.cn/mingadminmobile.php?m=homeSummary';
